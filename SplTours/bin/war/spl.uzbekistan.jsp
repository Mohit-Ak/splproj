...
<head>
	...
	<title>SPL Tours - Uzbekistan</title>
...
<!-- BEGIN: SITE-WRAPPER -->
<div class="site-wrapper spl-uzbekistan">
	
	<!-- START: PAGE TITLE -->
	<div class="row page-title">
		<div class="container clear-padding text-center">
			<h3>UZBEKISTAN:TASHNKET</h3>
			<h4>5Days/4Nights @ 33,333</h4>
			<span></i></span>
		</div>
	</div>
	<!-- END: PAGE TITLE -->
				...
				<div id="gallery" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="assets/images/uzbekistanbanner.jpg" alt="Uzbekistan Banner">
						</div>
						<div class="item">
							<img src="assets/images/uzbekistan1.jpg" alt="Uzbekistan1">
						</div>
						<div class="item">
							<img src="assets/images/uzbekistan-scenic.jpg" alt="Uzbekistan Scenic">
						</div>
					</div>
					...
					<div class="tab-content">
						<div id="overview" class="tab-pane fade">
							...
							<p>Tashkentcapital and largest city of Uzbekistan. 
								...
								Tashkent is the capital city of Uzbekistan.<br>
								It’s known for its many museums and its mix of modern and Soviet-era architecture.
							      </p>
										<p class="inc">
														</p>
						</div>
						<div id="inclusion" class="tab-pane fade">
							...
							<p class="inc">
								<i class="fa fa-check-circle"></i>Airfare on Uzbekistan Airways Ex-Delhi<br>
								<i class="fa fa-check-circle"></i>4 Nights Accommodation in 4  Hotels<br>
								<i class="fa fa-check-circle"></i>4 Buffet Breakfast, 4 Indian Lunches + 03 Indian Dinners + 01 Gala Dinner <br>
								<i class="fa fa-check-circle"></i>01 Gala Dinner with Veg-Non Veg Snacks <br>
								<i class="fa fa-check-circle"></i>Vodka<br>
								<i class="fa fa-check-circle"></i>Beer<br>
								<i class="fa fa-check-circle"></i>Soft Drinks & Exclusive Belly Dance shows <br>
								<i class="fa fa-check-circle"></i>02 bottles of 0.5 ltr water per person per day<br>
								<i class="fa fa-check-circle"></i>All Transportation by Luxury Ac Coach <br>
								<i class="fa fa-check-circle"></i>Professional English speaking escort guide from arrival to departure in Tashkent <br>
								<i class="fa fa-check-circle"></i>Full day trip to Charvak Lake & Chimgan Mountains <br>
								<i class="fa fa-check-circle"></i>Tashkent City Tour (Amir Temur Square, etc.)<br>
							    <i class="fa fa-check-circle"></i>Entrance fees for all monuments (except photo & video charges)<br>
							    <i class="fa fa-check-circle"></i>Your own alcohol with no extra charge <br>
							    <i class="fa fa-check-circle"></i>Photo & video charges<br>
					...
					<div class="sidebar-booking-box">
						...
						<div class="booking-box-body">
								...
								<div class="grand-total text-center">
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<button onclick="javascript:SPLUtil.bookPackage('Uzbekistan','4D5N')">BOOK</button>
									</div>
								</div>
