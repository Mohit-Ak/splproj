		...
		<div class="main-footer row">
			<div class="container clear-padding">
				...
				<div class="col-md-12 text-center we-accept">
					<h4>We Accept</h4>
					<ul>
						<li><img src="assets/images/card/visa.png" alt="Visa"></li>
						<li><img src="assets/images/card/mastercard.png" alt="Master"></li>
						<li><img src="assets/images/card/american-express.png" alt="American Express"></li>
					</ul>
				</div>
			</div>
		</div>
