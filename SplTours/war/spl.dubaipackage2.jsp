				...
				<div id="room-gallery" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="assets/images/dubai-hotel-jumeirah.jpg" alt="HotelJumeirah">
						</div>
						<div class="item">
							<img src="assets/images/dubai-madinat-jumeirah.jpg" alt="DubaiMadinatJumeirah">
						</div>
						<div class="item">
							<img src="assets/images/dubai-jumeirah-mosque.jpg" alt="DubaiJumeirahMosque">
						</div>
					</div>
					...
					<div class="sidebar-booking-box">
						...
						<div class="booking-box-body">
								...
								<div class="grand-total text-center">
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<button onclick="javascript:SPLUtil.bookPackage('Dubai','3D4N')">BOOK</button>
									</div>
								</div>
			...
			<div class="hotel-listing text-center">
				...
				<div class="col-md-4 col-sm-6">
					<div class="room-grid-view">
						<img src="assets/images/YouMayAlsoLike/bhurj-khalifa.jpg" alt="DubaiBhurjKhalifa">
						<div class="room-info">
				...
				<div class="col-md-4 col-sm-6">
					<div class="room-grid-view">
						<img src="assets/images/YouMayAlsoLike/europe-grand-canal.jpg" alt="GrandCanal">
						<div class="room-info">
							<div class="room-title">
								<h5>Bangkok</h5>
							</div>
