...
<head>
	...
	<title>SPL Tours - Indonesia</title>
				...
				<div id="room-gallery" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="assets/images/indonesia-mountbromo.jpg" alt="MountBromo">
						</div>
						<div class="item">
							<img src="assets/images/jakarta-skyline-indonesia.jpg" alt="SkylineIndonesia">
						</div>
						<div class="item">
							<img src="assets/images/indonesia-borobudur temple.jpg" alt="BorobudurTemple">
						</div>
					</div>
					...
					<div class="sidebar-booking-box">
						...
						<div class="booking-box-body">
								...
								<div class="grand-total text-center">
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<button onclick="javascript:SPLUtil.bookPackage('Indonesia','3D4N')">BOOK</button>
									</div>
								</div>
			...
			<div class="hotel-listing text-center">
				...
				<div class="col-md-4 col-sm-6">
					<div class="room-grid-view">
						<img src="assets/images/YouMayAlsoLike/museum-bali.jpg" alt="BaliMuseum">
						<div class="room-info">
				...
				<div class="col-md-4 col-sm-6">
					<div class="room-grid-view">
						<img src="assets/images/YouMayAlsoLike/bali-temples.jpg" alt="BaliTemples">
						<div class="room-info">
							<div class="room-title">
								<h5>Bangkok</h5>
							</div>
